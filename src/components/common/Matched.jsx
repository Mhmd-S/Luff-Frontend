...
const Matched = ({ userInfo, handleClick }) => {
  return (
    <div className="w-full h-full relative flex items-center justify-center after:absolute after:w-full after:h-3/4 after:content-[''] after:bg-gradient-to-t after:from-black after:to-transparent after:bottom-0 after:z-10 after:block after:left-0 md:w-1/3">
        
        {/* User's Picutre */}
        <img className="w-full h-full object-cover" src='./joh.jpg' alt={`Image`} />  
        

        <div className='w-full h-full absolute flex flex-col items-center pt-8 z-20 text-white'>
        ...
        <h1 className='text-slate-900 text-6xl md:text-6xl font-bold flex flex-col md:flex-row'>
            ...
            <button className='mt-6 text-lg bg-purple-500 p-3 rounded-xl'>
                <Link to='/message'>
                    Send a message
                </Link>
            </button>
