  ...
  return (
    <label htmlFor={id} className='flex items-center justify-center'>
      <input
        ...
        className="after:content[''] relative h-5 w-5 cursor-pointer appearance-none rounded-full border-2 border-blue-gray-200 text-black transition-all after:absolute after:top-2/4 after:left-2/4 after:block after:h-full after:w-full after:-translate-y-2/4 after:-translate-x-2/4 after:rounded-full after:opacity-0 after:bg-purple-600  checked:after:opacity-100"
        />
